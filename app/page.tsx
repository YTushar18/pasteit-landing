          ...
          <div className="max-w-5xl mx-auto">
            <Carousel options={{ loop: true, slidesToScroll: 1 }}>
              ...
              <CarouselItem>
                <div className="p-4">
                  <Image
                    src="/images/pasteit-job-application.jpg"
              ...
              <CarouselItem>
                <div className="p-4">
                  <Image
                    src="/images/pasteit-shopping-list.jpg"
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              <Logo />
              <p className="text-gray-400 mt-4">Your Ultimate Copy-Paste Manager</p>
            </div>
            <div>
